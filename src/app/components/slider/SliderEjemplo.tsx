...
width='200' 
height='180' 
className=' top-0 opacity max-w-48 max-h-44 lg:max-w-[600px] 2xl:max-w-[790px] lg:max-h-[500px] 2xl:max-h-[660px] lg:w-[789px] lg:h-[652px] ' 
/>
...
<div className='flex text-base w-4/5 flex-col justify-center items-center text-center lg:w-[40%] '>
  ...
  <button className='hidden lg:relative w-32 h-11 border-2 border-[#8E5500] bg-[#FFE6C2] rounded-lg '>Vamos</button>
