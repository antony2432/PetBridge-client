  ...
  return (
    <Fragment>
      ...
      <section onClick={handleOpen} className="text-center cursor-pointer first-letter:uppercase">
          <Typography variant="h2" color="blue-gray" className="mb-2 overflow-hidden max-h-12 text-GoldenYellow-600">
            {info.name}
          </Typography>
          ...
          <h3
              className='text-xl text-GoldenYellow-600'
      ...
      <Dialog open={open} handler={handleOpen} className='first-letter:uppercase bg-GoldenYellow-500 border-2 border-black max-w-[100%] min-w-[100%] 2xl:min-w-[60%] 2xl:w-[60%] lg:max-w-[40%] m-0 p-0  w-screen absolute h-screen min-h-screen max-h-screen sm:h-max sm:min-h-max overflow-y-scroll  lg:max-h-[1200px] scroll-chido'>
      ...
      <h2 className="text-5xl w-full h-full text-[#3d2a1d] p-8">Mi nombre es {info.name}!</h2></DialogHeader>
      ...
      <CardBody>
        <Typography className='flex flex-col my-5 h-[25vh] '>
            ...
            <ul className='text-xl grid grid-cols-2 justify-center items-center gap-5 ml-[12%] '>
              ...
              <li>Edad: 2 Meses</li>
              <li >Peso: 10kg</li>
              <li className='flex'>Pais:<h3 className='first-letter:uppercase'>{info.country}</h3></li>
              <li className='flex'>Estado: <h3 className='first-letter:uppercase'>{info.state}</h3></li>
              <li className='flex'>Ciudad: <h3 className='first-letter:uppercase'>{info.city}</h3></li>
            </ul>
            </section>
  </div>
          </section>
